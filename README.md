...
This is completely blank png's and jpg's. It's not recommended to upload this straight as is but instead modify the images to what UI you want to see. There's a .txt file in the first folder for a bit more description on what each file is.
